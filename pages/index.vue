<template>
  <div>
    <ul class="menu-list">
      <li>
        <NuxtLink to="/kelolabarang" class="menu-link">
          <span class="menu-icon">📚</span>
          <span class="menu-text">Kelola Barang</span>
        </NuxtLink>
      </li>
      <li>
        <NuxtLink to="/riwayattransaksi" class="menu-link">
          <span class="menu-icon">📚</span>
    ...
    <table class="min-w-full divide-y divide-gray-200">
      ...
      <tbody class="bg-white divide-y divide-gray-200">
        ...
        <tr>
          ...
          <td class="px-6 py-4 whitespace-nowrap">Rp 15.000</td>
          <td class="px-6 py-4 whitespace-nowrap">3</td>
          <td class="px-6 py-4 whitespace-nowrap">Rp 45.000</td>
          <td class="px-6 py-4 whitespace-nowrap">
            <button class="text-red-600 hover:text-red-900">Delete</button>
          </td>
        </tr>
      ...
      <li>
        <NuxtLink to="/resetkeranjang" class="menu-link">
          <span class="menu-icon">🔄</span>
          <span class="menu-text">Reset Keranjang</span>
        </NuxtLink>
      </li>
    </table>
    <h4 class="text-2xl font-semibold mb-4">Total Pembayaran = </h4> <br>
